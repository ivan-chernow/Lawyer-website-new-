  ...
  return (
    <section className="bg-grey py-[80px] services" id="services">
      <div className="container flex flex-col justify-center items-center">
        ...
        <ul className="flex flex-wrap mb-[48px]  items-center justify-between gap-[24px]">
          {servicesData.map((service: ServicesData) => (
            <motion.li
              ...
              className="flex flex-col  items-center justify-center bg-white  max-w-[400px]  min-h-[250px]  flex-auto cursor-pointer
							hover:bg-blue hover:text-white duration-300 svg-hover relative shadow-lg
							"
              key={service.title}
            >
              <svg
                ...
                className="w-[35px] h-[35px] mb-[15px] "
              >
                <path
