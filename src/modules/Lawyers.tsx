  ...
  return (
    <section className="flex flex-col items-center bg-grey py-[80px] lawyers">
      ...
      <p className="font-normal mt-[24px] mb-[48px] max-w-[920px] text-center">
        Наша команда юристов состоит из высококвалифицированных специалистов с
        богатым опытом в различных областях права. Мы обеспечиваем первоклассные
        ...
        {lawyers.map((lawyer, index) =>
          hoveredCard === index ? (
            ...
            >
              ...
              <p className="font-light text-[14px] mb-[40px] text-center max-w-[265px]">
                {lawyer.description}
              </p>
