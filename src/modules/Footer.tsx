		...
		<div>
			<footer className="py-[80px] bg-[#222222] footer" id='contacts'>
				<div className='container flex flex-col'>
					<div className='flex items-center justify-between mb-[96px] footer__flex-adaptive'>
						...
						<p className="font-normal text-white max-w-[862px] footer_desc">Предварительные выводы
							неутешительны: синтетическое
							тестирование, а
							также
							свежий взгляд на
							привычные вещи — безусловно открывает новые горизонты для экономической целесообразности принимаемых
							решений.</p>
					</div>
						...
						<ul className="flex flex-col">
							<li className="flex items-center mb-[24px]">
								...
								<div className="flex flex-col ">
									<p className="font-bold text-[12px]  text-gray-500 uppercase mb-[2px]">Наш адрес</p>
									<a href="https://yandex.ru/maps/-/CHqsjDpO" target="_blank"
										 className="text-white font-bold hover:text-blue hover:transition-all footer_address">г. Одинцово, улица Маршала
										Жукова, 28</a>
								</div>
							</li>
							<li className="flex items-center mb-[24px]">
								...
								<div className="flex flex-col">
									<p className="font-bold text-[12px]  text-gray-500 uppercase mb-[2px]">Запись на консультанцию</p>
									<a href="tel:" className="text-white font-bold hover:text-blue hover:transition-all">+7 (922)
										022-94-82</a>
								</div>
							</li>
							<li className="flex items-center">
								...
								<div className="flex flex-col">
									<p className="font-bold text-[12px]  text-gray-500 uppercase mb-[2px]">Корреспонденция</p>
									<a href="mailto:"
										 className="text-white font-bold hover:text-blue hover:transition-all">janis62@yahoo.com</a>
								</div>
							</li>
						</ul>
						<ul className="flex flex-col">
							<li className="font-bold text-[14px] text-white mb-[16px]">
								<NavLink to="services" smooth={true} duration={700}
												 className='hover:text-blue hover:transition-all cursor-pointer'>Услуги</NavLink>
							</li>
							<li className="font-bold text-[14px] text-white mb-[16px] cursor-pointer">
								<NavLink to="about" smooth={true} duration={700} className='hover:text-blue hover:transition-all'>О
									компании</NavLink>
							</li>
							<li className="font-bold text-[14px] text-white mb-[16px] cursor-pointer">
								<NavLink to="about" smooth={true} duration={700}
												 className='hover:text-blue hover:transition-all'>Сертификаты</NavLink>
							</li>
							<li className="font-bold text-[14px] text-white mb-[16px]">
								<NavLink to="clients" smooth={true} duration={700}
												 className='hover:text-blue hover:transition-all cursor-pointer'>Отзывы</NavLink>
							</li>
							<li className="font-bold text-[14px] text-white mb-[16px] cursor-pointer">
								<NavLink to="materials" smooth={true} duration={700}
												 className='hover:text-blue hover:transition-all'>Полезные
									материалы</NavLink>
							</li>
							<li className="font-bold text-[14px] text-white cursor-pointer">
								<Link href="/philantropy"
											className='hover:text-blue hover:transition-all'>Благотворительность</Link>
							</li>
						</ul>
						<div className='flex flex-col items-start '>
							<div className='flex items-center mb-[16px]'>
								<Image src='/img/Footer/footer-img.png' alt='img' className='mr-[24px]' width={65} height={65}/>
								<div className='flex flex-col'>
									<h3 className="font-bold text-[20px] text-white mb-[4px]">Миронов Александр</h3>
									<p className="text-[14px] font-light text-gray-300">Ведущий юрист</p>
								</div>
							</div>
							<p className="text-white font-normal text-[14px] mb-[24px] max-w-[424px] card_subtitle">Есть над чем задуматься:
								тщательные исследования
								конкурентов разоблачены. Идейные
								соображения
								высшего порядка, а также перспективное планирование играет </p>
							<Button text='Задать вопрос юристу' click={openModal} className='bg-blue border-blue
			...
			<section className='bg-black'>
				<div className='container flex items-center justify-between py-[16px]'>
					<p className='font-normal text-[14px] text-white footer_defence'>Все права защищены, 2025</p>
					<Link href="/philantropy"
								className='hover:text-blue hover:transition-all cursor-pointer font-normal text-[14px] text-white hidden adaptive'>Благотворительность</Link>
					<Link href="/privacy"
								className="hover:text-blue hover:transition-all cursor-pointer font-normal text-[14px] text-white ">Политика
