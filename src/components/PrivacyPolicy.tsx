      ...
      <div className="max-w-4xl mx-auto bg-white shadow-lg rounded-lg p-8">
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-600 leading-relaxed">
            ...
            «Политика») определяет порядок обработки персональных данных и меры
            по обеспечению безопасности персональных данных, предпринимаемые
            [Название компании] (далее — «Оператор»).
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc list-inside text-gray-600 space-y-2">
            ...
            <li>
              <strong>Оператор</strong> — государственный орган, юридическое или
