	...
	return (
		<div className="flex  flex-col items-center justify-center certificate">
			...
			<p className="text-center mb-8 max-w-[800px] mt-[24px]">
				Мы гордимся тем, что наша компания соответствует высочайшим стандартам качества и безопасности. Ознакомьтесь с
			...
			<ul className=" flex grid-cols-3 gap-8 flex-wrap">
				{certificates.map((cert, index) => (
					...
					>
						...
						/>
						<p className="text-gray-600 text-center text-[14px]">{cert.title}</p>
						{hoveredCard === index && (
